...
RED_FONT="\033[31m"
LIGHT_GREEN_FONT="\033[1;32m"
FONT_COLOR_SUFFIX="\033[0m"
INFO="[${LIGHT_GREEN_FONT}INFO${FONT_COLOR_SUFFIX}]"
ERROR="[${RED_FONT}ERROR${FONT_COLOR_SUFFIX}]"
[ $EUID != 0 ] && SUDO=sudo
...
install_key() {
    ...
    #&&：如果 [[ ... ]] 为真，则执行 echo -e "${INFO} ..."。
    #|| { ... }：如果 [[ ... ]] 为假，则执行 {} 代码块，输出错误并退出。
...
if [ "$RESTART_SSHD" = 1 ]; then
    ...
    echo -e "${INFO} Restart sshd to take effect."
fi